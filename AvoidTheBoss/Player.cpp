...
CTilePlayer::CTilePlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	...
	CGameObject* pGameObject = CGameObject::LoadGeometryFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Apache.bin");

	pGameObject->Rotate(15.0f, 0.0f, 0.0f);
	pGameObject->SetScale(15.0f, 15.0f, 15.0f);
	//pGameObject->SetPosition(10.0f, 100.0f, 10.0f);
